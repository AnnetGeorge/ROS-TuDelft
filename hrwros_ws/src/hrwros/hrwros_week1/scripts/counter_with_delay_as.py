...
if __name__ == '__main__':
    ...
    server = CounterWithDelayActionClass(rospy.get_name())      # get_name gets the name of the node and this is passed to the class so the action will have the same name
    rospy.spin()
